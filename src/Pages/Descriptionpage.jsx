  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#0a0a0a] text-white pt-20 px-[5%]">
        ...
        >
          <div className="absolute inset-10 mt-5 overflow-x-auto  scrollbar-hide transition-all  rounded-xl p-10 bg-gradient-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-lg ">
