    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
                ...
                className="relative w-full h-12 bg-gradient-to-r from-orange-500 to-[#a855f7] rounded-xl font-medium text-white overflow-hidden group transition-all duration-300 hover:scale-[1.02] hover:shadow-lg active:scale-[0.98] disabled:opacity-50 disabled:hover:scale-100 disabled:cursor-not-allowed"
            >
...
const Komentar = () => {
    ...
    return (
        ...
        <div className="p-6 space-y-6">
            ...
            <div className="space-y-4 max-h-[300px] md:max-h-[350px] overflow-y-auto custom-scrollbar" data-aos="fade-up" data-aos-delay="200">
                {comments.length === 0 ? (
