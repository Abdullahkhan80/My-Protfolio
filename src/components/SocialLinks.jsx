...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/abdullah-7a90632b8",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@Abdullah_khan10",
    icon: Instagram,
    url: "https://www.instagram.com/01abdullah_khan10/",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@abdullah",
    icon: Youtube,
    url: "https://www.youtube.com/@abdullahkhan-xn1ww",
    color: "#FF0000",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@Abdullahkhan80",
    icon: Github,
    url: "https://github.com/Abdullahkhan80",
    color: "#ffffff",
  ...
  },
  {
    ...
    url: "https://www.tiktok.com/@abdullahrauf55",
    color: "black",
...
const SocialLinks = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 pt-14 backdrop-blur-xl relative">
      <h3 className="text-xl font-semibold text-white mb-6 flex absolute p-5 top-0 left-0 items-center gap-2">
